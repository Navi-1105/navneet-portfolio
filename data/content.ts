...
export const projects = [
  {
    ...
    description: "Automated the extraction of salary components and legal clauses from PDF offer letters. Built a Flask web server to parse unstructured text, achieving >90% extraction accuracy.",
    link: "https://github.com/Navi-1105/" // Update specific link if available
  },
  {
  ...
  },
  {
    ...
    description: "Architected a scalable inventory management backend using Spring Boot. Optimized MySQL database schemas to handle high-volume transactions, improving query performance by 30%.",
    link: "https://github.com/Navi-1105/"
  }
];